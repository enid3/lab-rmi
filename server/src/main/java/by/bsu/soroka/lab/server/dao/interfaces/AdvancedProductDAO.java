...
public interface AdvancedProductDAO {
    /**
     * <b>Cascade remove</b>  of {@link by.bsu.soroka.lab.common.entity.Product} with <code>id</code> from data-storage.
     ...
     * @see {@link by.bsu.soroka.lab.server.service.impl.ProductServiceImpl#removeById(int)}
     */
